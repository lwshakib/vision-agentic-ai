      ...
      <div className="grid md:grid-cols-2 gap-8">
        {plans.map((plan) => (
          <Card
            ...
            className={
              plan.name === 'Pro'
                ? 'border-primary relative shadow-primary/10'
                : ''
            }
          >
            {plan.name === 'Pro' && (
            ...
            <CardContent className="space-y-6">
              ...
              <Button
                ...
                disabled={plan.current || plan.name === 'Pro'}
              >
                {plan.current
                  ? 'Current Plan'
                  : plan.name === 'Pro'
              ...
              {plan.name === 'Pro' && (
                <p className="text-[10px] text-center text-muted-foreground mt-2 italic font-medium">
